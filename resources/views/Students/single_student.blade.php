                                                        ...
                                                        <div class="fw-bold fs-4">
                                                            <div class="flex">
                                                                ...
                                                                <div class="d-flex justify-content-between"> 
                                                                    <span>First Term Average Score</span> 
                                                                    <span>-></span>
                        ...
                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                            ...
                            <div class="" >
                                ...
                                <div class="text-center">
                                    ...
                                    <span class="btn btn-light-primary print_button" style="cursor:pointer">Print Results</span>
                                </div>
                                <!--end::Actions-->
                            </div>
                            <!--end:Form-->
                        ...
                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                            ...
                            <form id="kt_modal_new_target_form" class="form" action="#">
                                ...
                                <div class="modal-footer text-center">
                                    <span class="btn btn-light me-3" data-bs-dismiss="modal">Cancel</span>
                                    <span class="btn btn-light-primary second-print-button">Print Results</span>
                                </div>
                                <!--end::Actions-->
                            </form>
                            <!--end:Form-->
                    ...
                    <div class="modal-contentrounded">
                        ...
                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                            ...
                            <form id="kt_modal_new_target_form" class="form" action="#">
                                ...
                                <div class="modal-footer text-center">
                                    <span class="btn btn-light me-3" data-bs-dismiss="modal">Cancel</span>
                                    <span class="btn btn-light-primary third-print-button">Print Results</span>
                                </div>
                                <!--end::Actions-->
                            </form>
                            <!--end:Form-->
